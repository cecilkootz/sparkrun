...
The end-to-end setup involves three sparkrun commands, followed by a cluster update. Register the cluster first so subsequent commands can reference it by name:
...
| 3. CX-7 networking | `sparkrun setup cx7` | Requires passwordless SSH from step 2 |
